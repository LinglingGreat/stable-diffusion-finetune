...
from ldm.data.dataset import CPUTransforms
...
class DataModuleFromConfig(pl.LightningDataModule):
    def __init__(self, batch_size, train=None, validation=None, test=None, predict=None,
                 ...
                 shuffle_val_dataloader=False, num_val_workers=None, epoch=1, seed=691):
        super().__init__()
    ...
    def _train_dataloader(self):
        ...
        if is_iterable_dataset or self.use_worker_init_fn:
            ...
            init_fn = None
        self.datasets["train"].shard(shuffle=True, epoch=self.epoch, seed=self.seed)
        return DataLoader(self.datasets["train"], batch_size=None, shuffle=False, num_workers=0, )
