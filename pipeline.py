...
class StableDiffusionControlSafetyCheckPipeline(StableDiffusionPipeline):
    r"""
...
class StableDiffusionImg2ImgControlSafetyCheckPipeline(StableDiffusionImg2ImgPipeline):
    r"""
